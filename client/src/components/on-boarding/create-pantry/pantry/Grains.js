        ...
        return (
            <div>
                ...
                <div className="text-center mx-8 mt-8 sm:mt-12 max-w-xl sm:mx-auto mb-32">
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-700">What are your favorite types of <span className="text-orange-base">grains?</span></h3>
                    ...
                    <div className="border-b border-gray-300 mb-4 pb-4">
                        ...
                        <div className="inline-block ml-1 mx-auto h-2 w-10 sm:w-16 bg-gray-300 rounded-full">
                            <div className="rounded-l-full bg-orange-base w-3/5 h-full"></div>
                        </div>
                    </div>
