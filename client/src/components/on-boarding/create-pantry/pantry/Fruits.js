...
class Fruit extends Component {
    ...
    createCheckboxesFromApi = (items, category) => {
        ...
        filteredList.map(
            item => (
                results.push(
                    <div key={item.name} className="w-1/2 sm:w-1/3">
                        <input
                            className="hidden"
                            id={item.name}
                            type="checkbox"
        ...
        return (
            <div>
                ...
                <div className="text-center mx-8 mt-8 sm:mt-12 max-w-xl sm:mx-auto mb-32">
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-700">What are your favorite types of <span className="text-orange-base">fruits?</span></h3>
                    ...
                    <div className="border-b border-gray-300 mb-4 pb-4">
                        ...
                        <div className="inline-block ml-1 mx-auto h-2 w-10 sm:w-16 bg-gray-300 rounded-full">
                            <div className="rounded-l-full bg-orange-base w-1/5 h-full"></div>
                        </div>
                    </div>
