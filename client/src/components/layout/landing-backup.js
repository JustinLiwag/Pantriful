...
class Landing extends Component {
  ...
  render() {
    return (
        <div>
            <header className="mt-8 mx-8 flex justify-between items-center xl:max-w-5xl xl:mx-auto">
                {/* Logo */}
                ...
                <div className="hidden sm:block sm:flex sm:items-center">
                    ...
                    <div className="ml-6 rounded border-2 border-green-400 py-2 px-8 text-green-400">Get Started</div>
                </div>
                ...
                <div className="sm:hidden">
                    ...
                    {/* Menu Modal */}
                    <div className={"mt-2 mr-8 px-4 py-2 absolute right-0 origin-top-right bg-white shadow-lg rounded-lg border border-gray-100 " + (this.state.menuOpen === false ? "hidden" : "absolute")}>
                        <div className="text-lg text-gray-700 text-right py-2 px-4">Login</div>
                        <div className="text-lg text-green-400 py-2 px-4">Sign Up</div>
                    </div>

                    {/* Close Menu Buttons. Opacity is 0 on display */}
                    <div className={"inset-0 opacity-0 w-full h-full z-30 " + (this.state.menuOpen || this.state.notificationsOpen ? "fixed" : "hidden")} onClick={this.closeMenuClick}></div>
                </div>
            </header>
            
            {/* Hero */}
            <div className="mt-12 md:mt-0 mx-4 md:flex md:items-center xl:justify-around xl:max-w-5xl xl:justify-between xl:mx-auto">
                <div className="max-w-xs sm:max-w-lg md:max-w-xs lg:max-w-md xl:max-w-lg mx-auto">
                    {/* Pill */}
                    ...
                    {/* CTA Button */}
                    <button className="mt-3 bg-green-400 py-3 px-8 rounded-lg text-white font-bold hover:bg-green-500 lg:text-xl lg:tracking-wide">Get Started Today!</button>
                </div>
            ...
            <main>
                ...
                <div className="mx-4 lg:mt-24 xl:max-w-5xl xl:mx-auto">
                    ...
                    {/* CTA Button */}
                    <button className="mt-8 md:mt-24 block mx-auto mt-3 bg-green-400 py-3 px-16 md:px-24 rounded-lg text-white md:text-2xl font-bold hover:bg-green-500">Get Started Today!</button>
                </div>
                ...
                <div className="mt-20">
                    ...
                    <div className="-mt-6 px-4 py-8 lg:px-12 mx-auto max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl bg-white shadow-lg rounded">
                        ...
                        {/* CTA Button */}
                        <button className="mt-8 block mx-auto mt-3 bg-green-400 py-3 px-8 rounded-lg text-2xl lg:text-3xl text-white font-bold hover:bg-green-500">Get Started Today!</button>
                    </div>
                </div>
