      ...
      <div className="main-container">
       ...
       <div className="container columns">
           <div className="left-hero column">
               ...
               <p className="has-text-centered-mobile">Pantriful takes the effort out of shopping for you food by using machine learning to predict and deliver your groceries without you having to think about it.</p>
     ...
     <div className="container">
         <div className="columns problem-content">
             <div className="column">
                 ...
                 <p>Up until now it was something you had to invest time and energy into. With Pantriful we use machine learning to help us predict, buy, and deliver the food that you want every week without you having to think about it. <br/><br/> We want Pantriful to help you get the food you need so you can focus on the food that you want. Stop thinking about your food and start enjoying it.</p>
             </div>
   ...
   <div className="container">
       <div className="columns solution-content">
           ...
           <div className="column solution-content-2">
               ...
               <p>Pantriful works by gradually building a custom food profile for you. This food profile will help us determine what you like, dislike and love. As you give us feedback and help us build your food profile we will be able to predict, buy and deliver your groceries without you ever having to think about it again.</p>
           </div>
       </div>
   </div>
</section>
...
<section className="features">
   <div className="container">
       <h4>THE FEATURES</h4>
       <h1>Save time and improve the way you eat. <br/>We only need 5 minutes.</h1>
       <p className="features-p">With Pantriful we not only aim to save you time but to also help you improve the way you eat. By crafting a unique food profile for you we will be able to help you refine the way you eat on your terms. <br/><br/> Here are some of the things we are working on.</p>
...
<section className="mission">
   <div className="container">
       ...
       <h1>Why We Do It</h1>
       <p className="mission-p">Pantriful was started to help us solve our own problem but quickly grew into a passion for helping others not only save time but also improve the way they eat. We want to build something that not only helps you but also is a resource for your daily life. </p>
       <h4>Core Values</h4>
   ...
   <div className="container">
       <div className="columns has-text-centered-mobile contact-content">
           <div className="column">
               ...
               <p className="contact-p">We are excited to share Pantriful with the world. We are looking for people to join our next batch of users to give us feedback and try out what we have built. <br/><br/>Sign up today to join our next batch of users!</p>
