    ...
    statusBoxText = () => {
      ...
      return(
        <div className="relative">
          <div className="mt-4 flex py-4 px-4 bg-green-500 shadow-lg rounded-lg">
            <div className="w-4/12 flex justify-center">
              <svg className="" width="71" height="71" fill="none" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
                <path d="M36 64.623c16.0163 0 29-12.8993 29-28.8115C65 19.8994 52.0163 7 36 7S7 19.8994 7 35.8115C7 51.7237 19.9837 64.623 36 64.623z" fill="#9AE6B4" />
                <mask id="a" maskUnits="userSpaceOnUse" x="7" y="7" width="58" height="58">
                  <path d="M36 64.623c16.0163 0 29-12.8993 29-28.8115C65 19.8994 52.0163 7 36 7S7 19.8994 7 35.8115C7 51.7237 19.9837 64.623 36 64.623z" fill="#C6F6D5" />
                </mask>
                <g mask="url(#a)">
                  <path fill="url(#pattern0)" d="M25.1865 25.0684h43.7457v43.4614H25.1865z" />
                  <mask id="b" maskUnits="userSpaceOnUse" x="25" y="25" width="44" height="44">
                    <path fill="url(#pattern1)" d="M25.1865 25.0684h43.7457v43.4614H25.1865z" />
                  </mask>
                  <g mask="url(#b)">
                    <path fill="#EE9986" d="M25.1865 25.0684h43.7457v43.4614H25.1865z" />
                  </g>
                  <path fill="url(#pattern2)" d="M31.8525 31.6909h31.247V61.493h-31.247z" />
                  <mask id="c" maskUnits="userSpaceOnUse" x="31" y="31" width="33" height="31">
                    <path fill="url(#pattern3)" d="M31.8525 31.6909h31.247V61.493h-31.247z" />
                  </mask>
                  <g mask="url(#c)">
                    <path fill="#fff" d="M31.8525 31.6909h31.247V61.493h-31.247z" />
                  </g>
                  <path fill="url(#pattern4)" d="M56.4336 45.3503h3.74963v3.72525H56.4336z" />
                  <mask id="d" maskUnits="userSpaceOnUse" x="56" y="45" width="5" height="5">
                    <path fill="url(#pattern5)" d="M56.4336 45.3503h3.74963v3.72525H56.4336z" />
                  </mask>
                  <g mask="url(#d)">
                    <path fill="#EE9986" d="M56.4336 45.3503h3.74963v3.72525H56.4336z" />
                  </g>
                </g>
                <circle cx="35.5" cy="35.5" r="34" stroke="#9AE6B4" stroke-width="3" />
                <defs>
                  <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use href="#image0" transform="scale(.00284)" />
                  </pattern>
                  <pattern id="pattern1" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use href="#image0" transform="scale(.00284)" />
                  </pattern>
                  <pattern id="pattern2" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use href="#image1" transform="scale(.00405 .00418)" />
                  </pattern>
                  <pattern id="pattern3" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use href="#image1" transform="scale(.00405 .00418)" />
                  </pattern>
                  <pattern id="pattern4" patternContentUnits="objectBoundingBox" width="1" height="1">
                    <use href="#image2" transform="scale(.03226)" />
                  </pattern>
            ...
            <div className="w-8/12 text-white">
              <p className="text-sm font-bold">I'm your pantriful assistant!</p>
              <p className="text-xs">You can ask me any questions or have me change up your orders as you see fit.</p>
              <button className="mt-2 text-xs bg-white text-green-500 px-8 py-1 rounded-full font-bold">Got it!</button>
            </div>
          </div>

          {/* CSS Background Elements */}
          <div className="hidden absolute top-0 rounded-full bg-green-600 h-32 w-32 z-10"></div>
        </div>
      )
    } 
