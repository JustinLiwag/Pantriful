      ...
      if (Object.keys(profile).length > 0) {
        ...
        dashboardContent = (
          <div className="mb-24">
            ...
            <svg className="mx-auto" width="235" height="235" viewBox="0 0 235 235" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M75.719 59.0071H75.2443V63.3957H75.719V59.0071Z" fill="#F2F2F2"/>
              ...
              <p className="px-8 sm:px-0 sm:max-w-xl mx-auto mt-2 px-4 text-md sm:text-lg text-gray-600 leading-relaxed sm:leading-loose">Let’s get to know you better so we can tailor the experience to fit your needs and preferences.</p>
